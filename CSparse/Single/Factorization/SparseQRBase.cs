...
namespace CSparse.Single.Factorization
{
        ...
        where T : struct, IEquatable<T>, IFormattable
    {
        ...
        protected CompressedColumnStorage<T, Real> Q, R;
        protected Real[] beta;
        ...
        /// </summary>
        protected abstract T CreateHouseholder(T[] x, int offset, ref Real beta, int n);

        /// <summary>
        /// Apply the ith Householder vector to x.
        /// </summary>
        protected abstract bool ApplyHouseholder(CompressedColumnStorage<T, Real> V, int i, Real beta, T[] x);
        ...
        protected void Factorize(CompressedColumnStorage<T, Real> A, IProgress<Real> progress)
        {
            ...
            var V = this.Q = CompressedColumnStorage<T, Real>.Create(m2, n, vnz);
            var R = this.R = CompressedColumnStorage<T, Real>.Create(m2, n, rnz);
            var b = this.beta = new Real[n];
        ...
        protected void SymbolicAnalysis(CompressedColumnStorage<T, Real> A, int[] p, bool natural)
        {
            int m = A.RowCount;
            int n = A.ColumnCount;
        ...
        private SymbolicColumnStorage Permute(CompressedColumnStorage<T, Real> A, int[] pinv, int[] q)
        {
            int t, j, k, nz = 0;
